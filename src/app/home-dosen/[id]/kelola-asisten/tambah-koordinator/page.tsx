...
export default withAuth(TambahKoor, ['dosen']);
...
function TambahKoor({ params }: { params: { id: string } }) {
  ...
  >({
    mutationFn: async (data) => {
      ...
      if (res.data) {
        showToast('Berhasil tambah Koordinator!', SUCCESS_TOAST);
      } else if (!res.data) {
        showToast('Gagal tambah Koordinator!', DANGER_TOAST);
        throw new Error('Gagal tambah Koordinator!');
      } else {
        showToast('Gagal tambah Koordinator!', DANGER_TOAST);
        throw new Error('Gagal tambah Koordinator!');
      }
