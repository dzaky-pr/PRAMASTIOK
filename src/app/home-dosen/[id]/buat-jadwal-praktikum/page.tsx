...
import { ModulType } from '@/app/home-dosen/[id]/kelola-modul/page';
...
export default withAuth(BuatJadwalpraktikan, ['dosen']);
...
function BuatJadwalpraktikan({ params }: { params: { id: string } }) {
  ...
  >({
    ...
    onSuccess: () => {
      ...
      router.push(`/home-dosen/${params.id}/daftar-jadwal-praktikum`);
    },
  });
