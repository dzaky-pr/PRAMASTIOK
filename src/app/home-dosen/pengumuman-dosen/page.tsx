...
export default withAuth(PengumumanAdmin, ['dosen']);
    ...
    >
      <section className='bg-darkGrey-800 relative flex min-h-screen w-full'>
        <div className='relative mx-20 flex w-full flex-col gap-6 pb-12 pt-28'>
                ...
                >
                  ...
                  >
                    ...
                    <div className='flex flex-row gap-0.5'>
                      ...
                      />
                      <Link
                        href={`/home-dosen/pengumuman-dosen/${data.pengumuman_id}/edit`}
                      >
                        <IconButton
                          icon={FaPen}
                          variant='ghost'
          ...
          <IconButton
            onClick={() => {
              router.push('/home-dosen/pengumuman-dosen/buat-pengumuman');
            }}
            icon={FaPlus}
