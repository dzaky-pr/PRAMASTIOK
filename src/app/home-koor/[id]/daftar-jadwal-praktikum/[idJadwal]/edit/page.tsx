...
export default withAuth(DaftarJadwalPraktikum, ['koordinator']);
        ...
        <div className=' pb-12 pt-28'>
          <div className='bg-darkGrey-800 container mx-auto flex w-screen flex-col gap-4 '>
                ...
                <div className='flex flex-col gap-3'>
                  <div className='flex flex-col gap-1.5'>
                    ...
                    <div className='flex flex-row justify-between'>
                      ...
                      <Link
                        href={`/home-koor/${params.id}/daftar-jadwal-praktikum/${jadwal.jadwal_id}/edit`}
                      >
                        <IconButton
                          icon={FaPen}
                          type='submit'
            ...
            <div className='flex justify-end'>
              <Link href={`/home-koor/${params.id}/buat-jadwal-praktikum`}>
                <IconButton
                  type='submit'
                  icon={FaPlus}
