...
import { ModulType } from '@/app/home-koor/[id]/kelola-modul/page';
...
export default withAuth(BuatJadwalpraktikan, ['koordinator']);
...
function BuatJadwalpraktikan({ params }: { params: { id: string } }) {
  ...
  >({
    ...
    onSuccess: () => {
      ...
      router.push(`/home-koor/${params.id}/daftar-jadwal-praktikum`);
    },
  });
